...
import 'package:sparc_todo_app/data/database-helper.dart';
import 'package:sparc_todo_app/event_list/todo_event.dart';
import 'package:sparc_todo_app/models/user.dart';
import 'package:sparc_todo_app/pages/login/login_presenter.dart';
...
class _LoginPageState extends State<LoginPage> implements LoginPageContract {
  ...
  void onLoginSuccess(User user) async {
    ...
    _showSnackBar( "Invalid password for user " + user.username);
    }
    setState(() {
      _isLoading = false;
    });
